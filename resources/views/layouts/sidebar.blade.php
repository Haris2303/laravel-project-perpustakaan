        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/dashboard/borrowings"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Kelola Peminjaman</span>
                </a>
            </li>
            <li>
                <a href="/dashboard/returneds"
                    class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5 5V.13a2.96 2.96 0 0 0-1.293.749L.879 3.707A2.96 2.96 0 0 0 .13 5H5Z" />
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Kelola Pengembalian</span>
                </a>
            </li>
            ...
            <form method="GET" action="/home"
                ...
                <a href="/home" class="ms-3 whitespace-nowrap">Kembali</a>
            </form>
            </li>
            <li>
                <form method="POST" action="{{ route('logout') }}"
                    ...
                    <!-- Authentication -->
                    @csrf
                    <button type="submit" class="ms-3 whitespace-nowrap">Logout</button>
                </form>
            </li>
        </ul>
    </div>
