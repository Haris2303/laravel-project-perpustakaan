    ...
    <div class="sm:ml-72 mt-10">
        <div class="w-[19rem] flex gap-10 shadow-md p-7 mb-10">
            ...
            <div class="flex flex-col justify-end items-end">
                <span class="text-3xl text-gray-900 font-bold">{{ $borrowings->count() }}</span>
                <span class="text-gray-700">Jumlah Peminjaman</span>
            </div>
        </div>
        ...
        @endif
        <div class="w-40 mb-3">
            <a href="/dashboard/borrowings/create" class="bg-gray-600 text-white py-1 px-5 rounded-lg">Tambah</a>
        </div>
